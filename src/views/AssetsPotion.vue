<template>
  ...
  >
      ...
      <div class="flex-def assets_content">
        <div class="ava-item">
          ...
          >
            ...
            <div class="transfer-item sell-item gray" v-if="false">
              <div class="img-col">
                <img src="@/assets/pic/sell.png" alt="" />
              </div>
              <div class="text-item">{{ $t("Transfer.sell") }}</div>
    ...
    <div class="assets-info">
      <div class="info-cel" style="display: none">
        <div
          class="d-title"
      ...
      <!-- <div class="info-cel">
        ...
        >
          <span v-if="!ifpolyDao" style="color: #5abc77;font-weight: 900;">{{ $t("yes") }}</span>
          <span v-if="ifpolyDao" style="color: #d44040;font-weight: 900;">{{ $t("no") }}</span>
        </div>
      </div> -->
...
import { get_potion_detail, get_poly_potion_address } from "@/api/apiPotion";
...
export default {
  ...
  methods: {
    ...
    async get_pre() {
      let that = this;
      let res = await get_poly_potion_address();
      that.contract_address = res.data;
    },

    async getNftInfo() {
      let that = this;
      let res = await get_potion_detail(that.myTokenID);
